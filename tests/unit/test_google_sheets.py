...
os.environ["GOOGLE_ACCESS_TOKEN"] = "test-token"
...
class TestReadSheet:
    ...
    def test_read_returns_values(self) -> None:
        ...
        with patch("servers.google_sheets.httpx.request", return_value=mock_response):
...
class TestWriteSheet:
    ...
    def test_write_returns_updated_range(self) -> None:
        ...
        with patch("servers.google_sheets.httpx.request", return_value=mock_response):
            result = write_sheet("spreadsheet123", "Sheet1!A1", [["Name", "Age"], ["Bob", "25"]])
